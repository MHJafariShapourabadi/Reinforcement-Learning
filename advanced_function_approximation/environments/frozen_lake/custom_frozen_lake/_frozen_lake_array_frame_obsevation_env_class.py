...
from ..wrappers import FrozenLakeArrayFrameObservationWrapper

class FrozenLakeArrayFrameObsevationEnvClass:
    ...
    def create_env(self, slip_epsilon, step_reward, hole_reward, goal_reward):
        ...
        modified_env = FrozenLakeArrayFrameObservationWrapper(
            env=env,
