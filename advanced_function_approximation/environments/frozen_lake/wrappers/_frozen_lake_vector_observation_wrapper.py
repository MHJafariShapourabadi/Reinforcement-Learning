...
class FrozenLakeVectorObservationWrapper(Wrapper):
    ...
    def __init__(self, env, slip_epsilon=0.3, step_reward=-1, hole_reward=0, goal_reward=0, 
                 active_neighbour=2, episode_auto_restart=True, seed=None):
        ...
        self.observation_space = MultiBinary(self.observation_shape, seed=seed)
