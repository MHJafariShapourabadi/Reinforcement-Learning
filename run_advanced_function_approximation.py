...
if __name__ == "__main__":
    ...
    # agent = PPOGAEPER(env=vector_env, n_step=5, lambd = 0.5, actor_lr_start=1e-2, actor_lr_end=1e-3, actor_lr_decay=0.00005, actor_decay="exponential", critic_lr_start=1e-1, critic_lr_end=1e-2, critic_lr_decay=0.000005, critic_decay="exponential", buffer_size=2048, batch_size=128, alpha_start=0.8, alpha_end=1.0, alpha_increment=1e-3, beta_start=0.4, beta_end=1.0, beta_increment=1e-4, r_clip_epsilon=0.2, v_clip_epsilon=0.2, entropy_coef=0.01, gamma=0.99, seed=None, verbose=False)
