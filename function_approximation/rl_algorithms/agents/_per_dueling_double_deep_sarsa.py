...
# DQN Agent
class PERDuelingDoubleDeepSarsa:
    ...
    def train(self, num_episodes):
        ...
        for episode in range(num_episodes):
            ...
            while True:
                ...
                # Select action
                next_action, next_greedy = self.select_action(next_state, info)
                
                done = terminated or truncated

                # Store in replay buffer
                self.buffer.push(state, action, reward, next_state, next_action, terminated)
